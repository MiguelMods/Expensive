...
public interface IGenericRepositoryWithResponse<TEntity, TResponse> where TEntity : BaseEntity where TResponse : BaseResponse, ICustomMapToResponse<TEntity, TResponse>
{
